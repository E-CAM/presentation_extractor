...
var chapterNav = function chapterNav(options) {
  ...
  player.ready(function () {
    ...
    player.controlBar.el().insertBefore(player.controlBar.chapterPrev.el(), player.controlBar.playToggle.el());

    player.controlBar.chapterNext = player.controlBar.addChild('ChapterNavButton', {
      direction: 'next'
    });
    player.controlBar.el().insertBefore(player.controlBar.chapterNext.el(), player.controlBar.playToggle.el().nextSibling);
  });
};
